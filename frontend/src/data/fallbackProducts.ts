...
export const fallbackProducts: Product[] = [
  {
    ...
    price: 24000,
    description:
      "화사한 꽃향기와 세련된 산미가 은은하게 이어지는 싱글 오리진 원두입니다.",
    imageUrl:
  ...
  },
  {
    ...
    price: 18000,
    description:
      "고소한 견과 향과 부드러운 단맛이 균형을 이루는 시즌 블렌드입니다.",
    imageUrl:
  ...
  },
  {
    ...
    imageUrl:
      "https://lh3.googleusercontent.com/aida-public/AB6AXuBLUIQCHdNMDK5DuFCtkU8NcHt-_XflT29T8kLZAceDcKUFBW7FBpPwBJOCfQwfpKi8HlqnoHgzQL3PRfVyYr1P_ql7EfJzGlQc5L-KhohIOhhJEiSPIrakrLZd7kjWECSzeSrJsM3KRJukT98TSToAY1pcZsH5tGxo2gAYypYw_idg-20kjO6zAf9qWeRRhuKxJwK3rBRKRvvpMAXJG0UMOTBeBoMX5avm-6dJdg3BF0Gfp_OfCPBVklk-bI1VYH2hcF2gEwaBIi8",
  },
];
